...
type Employee struct {
	...
	YearsOfExperience float32    `json:"years_of_experience" gorm:"column:years_of_experience"`
	CasualLeave       int        `json:"cl" gorm:"column:casual_leave"`
	EarnedLeave       int        `json:"el" gorm:"column:earned_leave"`
